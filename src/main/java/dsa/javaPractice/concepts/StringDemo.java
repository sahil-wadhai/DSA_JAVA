...
/* String methods
 ...
 name.split("-") regex parameter returns array : [Sahil, Wadhai]
...
- The replace(int,int,String) method replaces the given string from the specified beginIndex(included) and endIndex(excluded).
...
- charAt(int)
- length()
- substring(int,int) startIdx(included) and endIdx(excluded)
*/
