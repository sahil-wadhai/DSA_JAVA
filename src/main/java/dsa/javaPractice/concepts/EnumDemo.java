...
enum Color {
    //enum constants(instances) implicitly public static and final
    RED,
    GREEN,
    BLUE;
}
...
enum Operation{
    ...
    // Enums can have methods, fields, and constructors. Methods can be called on enum constants.
...
Every enum constant is implicitly public static final. Since it is static,
