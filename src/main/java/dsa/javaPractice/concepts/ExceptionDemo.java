...
public class ExceptionDemo {
    public static void main(String[] args) {
        ...
        /* Note:
        In Java exception handling, catch(SQLException | ClassNotFoundException e) allows a single catch block to
        handle multiple exception types. This feature pipe( | ), introduced in Java 7,
        simplifies code by avoiding redundant catch blocks when the handling logic is the same for different exceptions.
        */
